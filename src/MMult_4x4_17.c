...
//   c_03_c_33_vreg.v = _mm256_setzero_pd(); 
  ...
  for ( p=0; p<k; p++ ){
    ...
    b_p0_vreg.v = _mm256_broadcast_sd( (double *) b );       /* load and duplicate */
    b_p1_vreg.v = _mm256_broadcast_sd( (double *) (b+1) );   /* load and duplicate */
    b_p2_vreg.v = _mm256_broadcast_sd( (double *) (b+2) );   /* load and duplicate */
    b_p3_vreg.v = _mm256_broadcast_sd( (double *) (b+3) );   /* load and duplicate */

    b += 4;

    c_00_c_30_vreg.v = _mm256_add_pd(_mm256_mul_pd(a_0p_a_3p_vreg.v, b_p0_vreg.v), c_00_c_30_vreg.v);
    c_01_c_31_vreg.v = _mm256_add_pd(_mm256_mul_pd(a_0p_a_3p_vreg.v, b_p1_vreg.v), c_01_c_31_vreg.v);
    c_02_c_32_vreg.v = _mm256_add_pd(_mm256_mul_pd(a_0p_a_3p_vreg.v, b_p2_vreg.v), c_02_c_32_vreg.v);
    c_03_c_33_vreg.v = _mm256_add_pd(_mm256_mul_pd(a_0p_a_3p_vreg.v, b_p3_vreg.v), c_03_c_33_vreg.v);
  }

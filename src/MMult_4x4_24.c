...
void AddDot12x4( int k, double *a, int lda,  double *b, int ldb, double *c, int ldc )
{
  ...
  for ( p=0; p<k; p+=4 ){
    ...
    a_0p_a_3p_vreg.v = _mm256_loadu_pd( (double *) (a+12) );
    a_4p_a_7p_vreg.v = _mm256_loadu_pd( (double *) (a+16) );
    a_8p_a_11p_vreg.v = _mm256_loadu_pd( (double *) (a+20) );
    ...
    a_8p_a_11p_vreg.v = _mm256_loadu_pd( (double *) (a+32) );
    ...
    a_0p_a_3p_vreg.v = _mm256_loadu_pd( (double *) (a+36) );
    a_4p_a_7p_vreg.v = _mm256_loadu_pd( (double *) (a+40) );
    a_8p_a_11p_vreg.v = _mm256_loadu_pd( (double *) (a+44) );

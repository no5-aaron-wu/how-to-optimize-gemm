...
void AddDot4x4( int k, double *a, int lda,  double *b, int ldb, double *c, int ldc )
{
  ...
  for ( p=0; p<k; p++ ){
    ...
    c_00_c_30_vreg.v = _mm256_fmadd_pd(a_0p_a_3p_vreg.v, b_p0_vreg.v, c_00_c_30_vreg.v);
    c_01_c_31_vreg.v = _mm256_fmadd_pd(a_0p_a_3p_vreg.v, b_p1_vreg.v, c_01_c_31_vreg.v);
    c_02_c_32_vreg.v = _mm256_fmadd_pd(a_0p_a_3p_vreg.v, b_p2_vreg.v, c_02_c_32_vreg.v);
    c_03_c_33_vreg.v = _mm256_fmadd_pd(a_0p_a_3p_vreg.v, b_p3_vreg.v, c_03_c_33_vreg.v);
  }
